...
window.deprecationWorkflow.config = {
  workflow: [
    ...
    { handler: "silence", matchMessage: "DEPRECATION: You tried to look up 'store:main', but this has been deprecated in favor of 'service:store'. [deprecation id: ds.store.deprecated-lookup]" }
  ]
};
