...
export default Ember.Route.extend({
    ...
    afterModel: function(model) {
		...
		let layers = model.get('raster_layer_project_ids');

		let _this = this;

		// Add the layers to the map
		layers.forEach(function(projectLayer) {

			var layer = DS.PromiseObject.create({
				promise: _this.store.findRecord('raster_layer_project', projectLayer.id)
			});
    ...
    actions: {
		...
		//
	        var _this = this;
		//
		// 	// console.log(this.modelFor('project').get('raster_layer_project_ids'));
		// 	//
		// 	//
		// 	// console.log(Ember.computed.oneWay('raster_layer_project_ids.length'));
		//
		//
		//
            Ember.run.scheduleOnce('afterRender', function() {
				...
				// let layers = project.get('raster_layer_project_ids');
				//
